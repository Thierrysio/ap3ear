...
final class Version20250205120000 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE game4_duel DROP INDEX uniq_g4duel_pair_pending');
        $this->addSql('ALTER TABLE game4_duel DROP INDEX uniq_duel_playerA_pending');
        $this->addSql('ALTER TABLE game4_duel DROP INDEX uniq_duel_playerB_pending');
